  ...
  return (
    <div className="flex flex-col sm:flex-row justify-around gap-12 sm:gap-2 text-center py-20 text-xs sm:text-sm md:text-base text-gray-700">
      ...
      <div className="px-4 py-2 rounded shadow-2xl">
        <img src={assets.exchange_icon} className="w-12 m-auto mb-5" alt="Free Delivery Icon" />
      ...
      {/* Easy Returns Policy */}
      <div className="px-4 py-2 rounded shadow-2xl">
        <img src={assets.quality_icon} className="w-12 m-auto mb-5" alt="Easy Returns Icon" />
